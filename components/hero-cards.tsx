...
const cards = [
  ...
  { title: "ASD Skills",         href: "/asd-skills",         borderColor: "#6A8898", rotate:  2   },
  { title: "OCD Skills",         href: "/ocd-skills",         borderColor: "#7A9060", rotate: -1.5 },
  { title: "Mindfulness",        href: "/mindfulness",        borderColor: "#8A6048", rotate:  0.5 },
  { title: "Brain Games",        href: "/brain-games",        borderColor: "#C87040", rotate: -2   },
  { title: "Blog",               href: "/blog",               borderColor: "#9A7850", rotate:  1   },
  { title: "Madrone Love, PsyD", href: "/individual-therapy", borderColor: "#6A8898", rotate: -0.5 },
]

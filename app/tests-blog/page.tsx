...
const posts: BlogPost[] = [
  {
    ...
    blocks: [
      ...
      { type: "heading", text: "What Is the Inference Gap?" },
      {
        type: "paragraph",
      ...
      { type: "heading", text: "When the Gap Becomes a Threat" },
      {
        type: "paragraph",
      ...
      { type: "heading", text: "OCD: When the Gap Fills Itself with Worst-Case Scenarios" },
      {
        type: "paragraph",
      ...
      { type: "heading", text: "Neurodivergence: Navigating a World Built for Different Inferential Wiring" },
      {
        type: "paragraph",
      ...
      { type: "heading", text: "Imagination Makes It More or Less Vivid" },
      {
        type: "paragraph",
      ...
      { type: "heading", text: "What This Means for Healing" },
      {
        type: "paragraph",
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: "heading", text: "The Inference-Based Model" },
      {
        type: "paragraph",
      ...
      { type: "heading", text: "Absorption and the Permeable Border" },
      {
        type: "paragraph",
      ...
      { type: "heading", text: "The Vividness Dimension" },
      {
        type: "paragraph",
      ...
      { type: "heading", text: "Three Routes to One Problem" },
      {
        type: "paragraph",
...
export default function TestsBlogPage() {
  const [tab, setTab] = useState<"tests" | "blog">("tests")

  return (
    <ToolPageLayout title="TESTS + BLOG" color="text-nav-teal">
      {/* Tab switcher */}
      <div className="flex gap-2 mb-10">
        {([["tests", "Tests"], ["blog", "Blog"]] as const).map(([key, label]) => (
          <button
            key={key}
            onClick={() => setTab(key)}
            style={{
              ...
              padding: "8px 20px",
              borderRadius: "999px",
              border: `2px solid #5BA89E`,
              background: tab === key ? "#5BA89E" : "transparent",
              color: tab === key ? "#fff" : "#5BA89E",
              cursor: "pointer",

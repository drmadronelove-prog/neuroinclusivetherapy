...
export default function NeurodiversityPage() {
  const [tab, setTab] = useState<"map" | "tests">("map")
          ...
          <section className="min-h-screen px-6 lg:px-16 pt-24 md:pt-12 pb-20">
            <div className="max-w-6xl mx-auto w-full">
              ...
              <div className="flex gap-2 mb-10">
                {([["map", "Map"], ["tests", "Tests"]] as const).map(([key, label]) => (
                  <button
                    key={key}
                    onClick={() => setTab(key)}
                    style={{
                      ...
                      background: tab === key ? "#B89878" : "transparent",
                      color: tab === key ? "#fff" : "#B89878",
                      cursor: "pointer",

...
export default function ASDSkillsPage() {
  return (
    <ToolPageLayout title="ASD SKILLS" color="text-nav-coral">
      <div className="space-y-14">
        ...
        <div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {skills.map(skill => (
              <div
                key={skill.title}
                className={`bg-card border border-border border-l-2 ${skill.color} rounded-lg p-5`}
              >
        ...
        {/* Framing note */}
        <div className="border-l-2 border-nav-coral pl-6 max-w-prose">
